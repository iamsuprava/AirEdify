...
//!changed top line and wrote this

class AppColors {
  static const Color primaryColor = Color.fromARGB(255, 12, 52, 255);
  //Shades of primary color
  static const Color primary200 = Color.fromARGB(255, 0, 242, 255);
  static const Color primary300 = Color.fromARGB(255, 0, 74, 185);
  ...
  static const Color yellow100 =
      Color.fromARGB(255, 27, 229, 202); //5EE2CF//0xFFF7C259
  static const Color yellow300 = Color.fromARGB(255, 27, 229, 202);
  static const Color yellow400 = Color.fromARGB(255, 27, 229, 202);
  static const Color yellow450 = Color.fromARGB(255, 27, 229, 202);
  static const Color yellow500 = Color.fromARGB(255, 27, 229, 202);
  static const Color yellow700 = Color.fromARGB(255, 27, 229, 202);
